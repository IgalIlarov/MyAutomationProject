...
public class ProductsPage extends BasePage{
	...
	public void sortAtoZ() {
		highlightElement(sortBtn, "yellow");
		sleep(300);
		click(sortBtn);
		sleep(500);
		highlightElement(azBtn, "yellow");
		sleep(300);
		click(azBtn);
		sleep(500);
	}
	...
	public void sortLowToHigh() {
		...
		click(sortBtn);
		sleep(500);
		highlightElement(loHiBtn, "yellow");
		sleep(300);
		click(loHiBtn);
		sleep(500);
	}
	...
	public void sortHighToLow() {
		...
		click(sortBtn);
		sleep(500);
		highlightElement(hoLoBtn, "yellow");
		sleep(300);
		click(hoLoBtn);
		sleep(500);
	}
